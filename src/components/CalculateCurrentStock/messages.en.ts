const messagesEn = {
  'components.calculateCurrentStock.yearlyIncrement': 'Yearly increment',
  'components.calculateCurrentStock.averageYearlyHarvestingAmount':
  ...
  'components.calculateCurrentStock.invalidYears':
    'The current year must be after the year of the stock at a point of time',
};
